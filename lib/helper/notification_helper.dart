      ...
      try{
        ...
        if(payload != null && payload.isNotEmpty) {
          ...
          if(_payload.notificationType == NotificationType.order) {
            Get.toNamed(RouteHelper.getOrderDetailsRoute(int.parse(_payload.orderId!)));
      ...
      try{
        if(message.data != null || message.data.isNotEmpty) {
          ...
          if(_notificationBody.notificationType == NotificationType.order) {
            ...
            Get.toNamed(RouteHelper.getChatRoute(notificationBody: _notificationBody, conversationID: _notificationBody!.conversationId!, user: null, index: null));
          }
        }
      }catch (e) {}
    });
