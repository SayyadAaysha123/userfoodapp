...
class Variation {
  ...
  Variation({required this.name, required this.multiSelect, required this.min, required this.max, required this.required, required this.variationValues});
...
class VariationValue {
  ...
  VariationValue({required this.level, required this.optionPrice});
