...
class ZoneModel {
  ...
  ZoneModel({required this.id, required this.name, required this.coordinates, required this.status, required this.createdAt, required this.updatedAt, required this.restaurantWiseTopic, required this.customerWiseTopic, required this.deliverymanWiseTopic, required this.minimumShippingCharge, required this.perKmShippingCharge});
