  ...
  void initState() {
    ...
    if(_isLoggedIn) {
      Get.find<LocationController>().getZone(
        ...
        Get.find<LocationController>().getUserAddress().longitude.toString(), false, updateInAddress: true
      );
              ...
              if(restController.restaurant != null) {
                _cartList?.forEach((cartModel) {
                  ...
                  double? _dis = (restController.restaurant.discount != null
                      && DateConverter.isAvailable(restController.restaurant.discount!.startTime.toString(), restController.restaurant.discount!.endTime.toString(), time: ))
