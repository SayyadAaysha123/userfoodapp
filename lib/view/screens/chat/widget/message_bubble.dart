...
class MessageBubble extends StatelessWidget {
  ...
  const MessageBubble({ required this.message, required this.user, required this.userType}) ;
  ...
  Widget build(BuildContext context) {
    ...
    return (message != null && _isReply) ? Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(
          DateConverter.localDateToIsoStringAMPM(DateTime.parse(message.createdAt.toString())),
