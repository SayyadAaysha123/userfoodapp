...
class _ForgetPassScreenState extends State<ForgetPassScreen> {
  ...
  String? _countryDialCode = CountryCode.fromCountryCode(Get.find<SplashController>().configModel!.country.toString()).dialCode;
            ...
            Container(
              ...
              child: Row(children: [
                CodePickerWidget(
                  ...
                  initialSelection: CountryCode.fromCountryCode(Get.find<SplashController>().configModel!.country.toString()).code.toString(),
                  favorite: [CountryCode.fromCountryCode(Get.find<SplashController>().configModel!.country.toString()).code.toString()],
