...
class ProductView extends StatelessWidget {
  ...
  ProductView({required this.restaurants, required this.products, required this.isRestaurant, this.isScrollable = false,
    this.shimmerLength = 20, this.padding = const EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL), required this.noDataText,
    this.isCampaign = false, this.inRestaurantPage = false, required this.type, required this.onVegFilterTap, this.showTheme1Restaurant = false});
