...
class BottomCartWidget extends StatelessWidget {
  const BottomCartWidget({required Key key}) : super(key: key);
        ...
        return Container(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Text(
                'total'.tr + ': ' + PriceConverter.convertPrice(cartController.calculationCart(), discount: null, discountType: '',  ),
                style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).primaryColor),
              ),
            ]),

            CustomButton(buttonText: 'view_cart'.tr,width: 130,height: 45, onPressed: () => Get.toNamed(RouteHelper.getCartRoute()), margin: null, icon: null, fontSize: null,)
          ]),
        );
      });
  }
