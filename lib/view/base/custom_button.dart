...
class CustomButton extends StatelessWidget {
  ...
  final double radius;
  final IconData? icon;
  CustomButton({required this.onPressed, required this.buttonText, this.transparent = false, required this.margin, required this.width, required this.height,
    required this.fontSize, this.radius = 5, required this.icon});
