...
class ProductWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if(isRestaurant) {
      ...
      _isAvailable = DateConverter.isAvailable(product.availableTimeStarts!, product.availableTimeEnds!, time: null);
    }
      ...
      onTap: () {
        if(isRestaurant) {
          ...
          ResponsiveHelper.isMobile(context) ? Get.bottomSheet(
            ProductBottomSheet(product: product, inRestaurantPage: inRestaurant, isCampaign: isCampaign, cartIndex: null, cart: null,),
            backgroundColor: Colors.transparent, isScrollControlled: true,
          ) : Get.dialog(
            Dialog(child: ProductBottomSheet(product: product, inRestaurantPage: inRestaurant, cart: null, cartIndex: null,)),
          );
        }
      },
      child: Container(
            ...
            child: Row(children: [
              ...
              ((_image != null && _image.isNotEmpty) || isRestaurant) ? Stack(children: [
                ...
                DiscountTag(
                  ...
                  freeDelivery: isRestaurant ? restaurant.freeDelivery! : false, fontSize: null,
                ),
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  isRestaurant ? RatingBar(
                    ...
                    _discount > 0 ? Text(
                      PriceConverter.convertPrice(product.price!, discount: null, discountType: ''),
