...
class ProductBottomSheet extends StatefulWidget {
  ...
  ProductBottomSheet({required this.product, this.isCampaign = false, required this.cart, required this.cartIndex, this.inRestaurantPage = false});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GetBuilder<ProductController>(builder: (productController) {
        ...
        bool _isAvailable = DateConverter.isAvailable(widget.product.availableTimeStarts!, widget.product.availableTimeEnds!, time: null);
            ...
            Padding(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  (widget.product.image != null && widget.product.image!.isNotEmpty) ? Padding(
                    ...
                    child: InkWell(
                      ...
                      child: Stack(children: [
                        ...
                        DiscountTag(discount: _discount, discountType: _discountType, fromTop: 20, fontSize: null,),
                      ]),
                    ),
                  ) : SizedBox.shrink(),
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Row(children: [
                        _price > priceWithDiscount ? Text(
                          '${PriceConverter.convertPrice(_price, discountType: '', discount: null)}',
                        ...
                        (widget.product.image != null && widget.product.image!.isNotEmpty)? SizedBox.shrink()
                            : DiscountTagWithoutImage(discount: _discount, discountType: _discountType, fontSize: null,),
                      ]),
                        ...
                        itemBuilder: (context, i) {
                          return InkWell(
                            ...
                            child: Row(children: [
                              ...
                              Text(
                                '${widget.product.variations![index].variationValues![i].optionPrice! > 0 ? '+'+ PriceConverter.convertPrice(widget.product.variations![index].variationValues![i].optionPrice!, discount: null, discountType: '') : 'free'.tr}',
                                maxLines: 1, overflow: TextOverflow.ellipsis,
                          ...
                          child: Column(children: [
                            Expanded(
                              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                ...
                                SizedBox(height: 5),
                                Text(
                                  widget.product.addOns![index].price! > 0 ? PriceConverter.convertPrice(widget.product.addOns![index].price!, discount: null, discountType: '') : 'free'.tr,
                                  maxLines: 1, overflow: TextOverflow.ellipsis,
                ...
                Row(children: [
                  ...
                  SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  Text(PriceConverter.convertPrice(priceWithAddonsVariation, discountType: '', discount: null), style: robotoBold.copyWith(color: Theme.of(context).primaryColor)),
                  SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  Text(
                    '(${PriceConverter.convertPrice(priceWithAddonsVariationWithoutDiscount, discountType: '', discount: null)})',
                ...
                (!widget.product.scheduleOrder! && !_isAvailable) ? SizedBox() : Row(children: [
                  ...
                  Expanded(child: CustomButton(
                    ...
                    }, icon: null, height: null, fontSize: null, margin: null,
                  )),
                ]),
              ]),
            ),
