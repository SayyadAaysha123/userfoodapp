  ...
  Future<void> initializeTimeSlot(Restaurant restaurant) async {
    ...
    for(int index=0; index<restaurant.schedules!.length; index++) {
      DateTime _openTime = DateTime(
        _now.year, _now.month, _now.day, DateConverter.convertStringTimeToDate(restaurant.schedules![index].openingTime.toString()).hour,
        DateConverter.convertStringTimeToDate(restaurant.schedules![index].openingTime.toString()).minute,
      );
      DateTime _closeTime = DateTime(
        _now.year, _now.month, _now.day, DateConverter.convertStringTimeToDate(restaurant.schedules![index].closingTime.toString()).hour,
        DateConverter.convertStringTimeToDate(restaurant.schedules![index].closingTime.toString()).minute,
      );
